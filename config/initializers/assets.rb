...
Rails.application.config.assets.precompile += %w( footable.core.css )
Rails.application.config.assets.precompile += %w( footable.js )
Rails.application.config.assets.precompile += %w( settleup.js )
Rails.application.config.assets.precompile += %w( itemform.js )
