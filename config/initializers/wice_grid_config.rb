if defined?(Wice::Defaults)
  ...
  # If you change the format, make sure to check this code
  ...
  # With Calendar helpers enabled the parameter sent is the string displayed.
  # This lambda will be given a date string in the
